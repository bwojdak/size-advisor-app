...
const messages: Record<Locale, Record<string, string>> = {
  pl: {
    ...
    "plans.feat.priority_support": "Wsparcie priorytetowe",
    ...
    "products.field.image.note": "Zdjęcie jest przekazywane modelowi AI jako dodatkowe źródło wymiarów.",
    ...
    "settings.tester.fitScale": "Suwak dopasowania: {smaller} ‹ {size} › {larger}",
    "settings.tester.fitPos": "pozycja w rozmiarze: {v} ({dir})",
    "settings.tester.fitPos.smaller": "bliżej mniejszego",
    "settings.tester.fitPos.larger": "bliżej większego",
    "settings.tester.fitPos.mid": "środek",
    "settings.tester.fitPos.none": "środek (brak danych wymiarowych)",
  ...
  en: {
    ...
    "plans.feat.priority_support": "Priority support",
    ...
    "products.field.image.note": "The image is passed to the AI model as an extra source of measurements.",
    ...
    "settings.tester.fitScale": "Fit scale: {smaller} ‹ {size} › {larger}",
    "settings.tester.fitPos": "position within size: {v} ({dir})",
    "settings.tester.fitPos.smaller": "toward the smaller size",
    "settings.tester.fitPos.larger": "toward the larger size",
    "settings.tester.fitPos.mid": "centre",
    "settings.tester.fitPos.none": "centre (no measurement data)",
